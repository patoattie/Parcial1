...
{
	public static function altaPizza($tipo, $sabor, $cantidad, $precio)
	{
		...
		else
		{
			...
			PizzaCargaPlus::guardarAlta($pizza);
			echo "<br>Se dio de alta la Pizza $id - $tipo - $sabor - $cantidad - $precio<br>";
		}
	}

	public static function guardarAlta($pizza)
	{
		$arrayPizzas = Pizza::leerPizzas("archivos/Pizza.txt");
		$hayStock = false;
	...
	{
		$pizzaValida = PizzaCargaPlus::obtenerPizza($tipo, $sabor);
